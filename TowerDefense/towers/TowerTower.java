...
public class TowerTower extends ATower {
    ...
    public TowerTower(int level, int damage, int range, int cost, int upgradeCost, BufferedImage sprite,
            TileManager tileManager, int slowFactor) {
        super(1, damage, 300, 80, 10, sprite, 3, 0);
        this.sprite = sprite;
